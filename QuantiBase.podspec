#
#  Be sure to run `pod spec lint QuantiBase.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  Base-ios repository consists of useful extensions, general classes and protocols 
  ...
  s.homepage     = "https://www.quanti.cz"
  ...
  #
    ...
    s.source       = { :git => "https://github.com/Qase/base-ios.git", :tag => "v0.0.1" }
